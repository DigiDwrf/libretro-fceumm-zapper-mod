...
{
        zapdata[0] = input_cb(port, RETRO_DEVICE_JOYPAD, 0, lightgunmap[0].retro) ? bindmap[0].nes : 0;
        zapdata[1] = input_cb(port, RETRO_DEVICE_JOYPAD, 0, lightgunmap[1].retro) ? bindmap[1].nes : 0 << 1;
}
